...
Below are examples of t-SNE visualizations generated by the script. These visualizations help in understanding the distribution and separation of different groups in the dataset.

| Hypo Group | Normal Group |
|:----------:|:------------:|
| ![Hypo Group](./images/hypo_tsne.png) | ![Normal Group](./images/normal_tsne.png) |
| *t-SNE visualization of the Hypo group* | *t-SNE visualization of the Normal group* |

| Prehyper Group | Hyper2 Group |
|:--------------:|:------------:|
| ![Prehyper Group](./images/prehyper_tsne.png) | ![Hyper2 Group](./images/hyper2_tsne.png) |
